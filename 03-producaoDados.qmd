# Produção dos Dados {#sec-producao}
...
**Amostra de conveniência**: é uma técnica comum onde é selecionada uma amostra que esteja acessível. Em outras palavras, os indivíduos são recrutados porque eles estão prontamente disponíveis. Neste tipo de amostra há incapacidade de fazer afirmações gerais com rigor estatístico sobre a população.
...
![Desenho de um estudo caso controle.](images/caso_controle.png){#fig-cc fig-align="center" width="11.1cm"}
...
![Desenho de um estudo caso-controle aninhado.](images/cc_aninhado.png){#fig-aninhado fig-align="center" width="13.5cm"}
...
![Desenho de um estudo de coorte sobre risco.](images/coorte.png){#fig-coorte fig-align="center" width="12cm"}
...
![Desenho de uma coorte com grupos expostos e não expostos](images/coorte_exposto_nao-exposto.png){#fig-coorte2 fig-align="center" width="12cm"}
...
![Estrutura de um ensaio clínico randomizado.](images/estrutura_trial.png){#fig-trial fig-align="center" width="14cm"}
...
Calcula-se uma série de estimativas quantitativas para analisar a magnitude do efeito da intervenção em um ensaio clínico. Entre elas, destacam-se o **Risco Relativo**, **Redução Relativa do Risco**, **Número Necessário para Tratar** que serão estudados no @sec-ocorrencia.
...
![Ensaio clínico randomizado com delineamento cruzado.](images/trial_cruzado.png){#fig-cruzado fig-align="center" width="6.2cm"}
...
No estudo da prevenção primária do câncer, os autores concluíram, após 12 anos de suplementação de betacaroteno, que o mesmo não produziu nem benefícios nem prejuízos em termos de incidência de câncer [@hennekens1996lack].
...
- **Fase I** - Um estudo de fase I testa a droga pela primeira vez. O objetivo principal é avaliar a segurança do produto investigado. Nesta fase, o medicamento é testado em pequenos grupos (10 – 30 pessoas), geralmente, de voluntários sadios. Podem existir exceções quando são avaliados medicamentos para câncer ou para portadores de HIV-AIDS. Se a droga se mostrar segura, é possível ir para a Fase II.
